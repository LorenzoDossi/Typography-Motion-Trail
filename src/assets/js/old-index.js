...
const circleGeometry = new THREE.PlaneBufferGeometry( 1, 1)
...
const postFXGeometry = new THREE.PlaneBufferGeometry(1, 1)
...
const postFXMaterial = new THREE.ShaderMaterial({
  ...
  fragmentShader: `
    ...
    void main () {
      ...
      inputColor *= 0.9;
      // inputColor = smoothstep(0.1, 0.4, inputColor);
...
function onResize() {
  ...
  circleMesh.scale.set(innerWidth, innerHeight, 1)
  postFXMesh.scale.set(innerWidth, innerHeight, 1)
}
